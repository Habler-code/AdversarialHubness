...
from hubscan import scan, quick_scan, get_suspicious_documents, explain_document, Verdict
...
def example_basic_scan():
    ...
    results = scan(
        ...
        metadata_path=str(Path(__file__).parent.parent / "data" / "toy_metadata.json"),
        k=10,
        num_queries=100,
...
if __name__ == "__main__":
    ...
    if not os.path.exists(toy_embeddings_path):
